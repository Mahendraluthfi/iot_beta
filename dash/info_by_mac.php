...
$sql2 = "SELECT * FROM master_data WHERE mac='".$mac."' order by time desc limit 1";

$result2 = $conn->query($sql2);

//TODAY COUNT
$sql_today = "SELECT COUNT(DISTINCT ts) AS today FROM master_data WHERE mac='".$mac."' AND d2 IS NOT NULL AND time >= DATE(NOW())";
...
//15 min COUNT
$sql_min15 = "SELECT COUNT(DISTINCT ts) AS min15 FROM master_data WHERE mac='".$mac."' AND d2 IS NOT NULL AND time >= DATE_ADD(NOW(), INTERVAL -15 MINUTE)";
